...
bool Handler::collistionWithEnemy(GameObject player, std::vector<GameObject> enemies, sf::Vector2f direction){
...
void Handler::handleMovement(GameObject player, std::vector<GameObject> enemies){
